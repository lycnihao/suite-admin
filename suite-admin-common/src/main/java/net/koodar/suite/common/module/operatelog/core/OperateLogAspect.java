package net.koodar.suite.common.module.operatelog.core;
...
public class OperateLogAspect {
	...
	public void doAfterReturning(JoinPoint joinPoint, net.koodar.suite.common.module.operatelog.annoation.OperateLog operateLog, Object jsonResult) {
		handleLog(joinPoint, null);
	}

	@AfterThrowing(value = "@within(operateLog)", throwing = "e")
	public void doAfterThrowing(JoinPoint joinPoint, net.koodar.suite.common.module.operatelog.annoation.OperateLog operateLog, Exception e) {
